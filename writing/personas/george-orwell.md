...
<menu>
  <item cmd="NE or fuzzy match on new essay, write essay, create essay, start" workflow="{rbtv_path}/writing/workflows/writing/workflow.md">[NE] New Essay: Build a rigorous, evidence-backed essay from scratch</item>
  <item cmd="CE or fuzzy match on continue essay, resume, pick up" workflow="{rbtv_path}/writing/workflows/writing/workflow.md">[CE] Continue Essay: Resume an essay in progress</item>
  <item cmd="CR or fuzzy match on critical review, review, critique, analyze" exec="{rbtv_path}/writing/tasks/critical-essay-review.xml">[CR] Critical Review: Tear apart a text for fallacies, weak logic, and shallow thinking</item>
  ...
  <action id="style-guide-management">
    <instruction>
      ...
      3. If not found — offer to create one:
         ...
         Template location: {rbtv_path}/writing/workflows/writing/data/style-guide-template.md
