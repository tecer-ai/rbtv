...
todos:
  - id: p1-1
    content: "p1-1: CREATE IDE command entry point. MUST read and follow ./phase-1/p1-1.task.md"
    status: completed
  - id: p1-2
    content: "p1-2: CREATE YC mentor agent. MUST read and follow ./phase-1/p1-2.task.md"
    status: completed
  - id: p1-3
    content: "p1-3: CREATE project-memo template. MUST read and follow ./phase-1/p1-3.task.md"
    status: completed
  - id: p1-4
    content: "p1-4: CANCELLED — founder-diary eliminated per Discovery 1 in shape.md"
    status: cancelled
  - id: p1-checkpoint
    content: P1 CHECKPOINT — Review foundation components before proceeding
    status: completed
  - id: p2-1
    content: "p2-1: CREATE master workflow entry. MUST read and follow ./phase-2/p2-1.task.md"
    status: completed
  - id: p2-2
    content: "p2-2: CREATE founder-process knowledge file. MUST read and follow ./phase-2/p2-2.task.md"
    status: completed
  - id: p2-3
    content: "p2-3: CREATE init step (mode selection). MUST read and follow ./phase-2/p2-3.task.md"
    status: completed
  - id: p2-4
    content: "p2-4: CREATE project setup step. MUST read and follow ./phase-2/p2-4.task.md"
    status: completed
  - id: p2-5
    content: "p2-5: CREATE milestone selection step. MUST read and follow ./phase-2/p2-5.task.md"
    status: completed
  - id: p2-checkpoint
    content: P2 CHECKPOINT — Validate master workflow routing logic
    status: completed
  - id: p3-1
    content: "p3-1: CREATE M1 milestone workflow. MUST read and follow ./phase-3/p3-1.task.md"
    status: completed
  - id: p3-2
    content: "p3-2: CREATE bi-m1-working-backwards framework workflow. MUST read and follow ./phase-3/p3-2.task.md"
    status: completed
  - id: p3-3
    content: "p3-3: CREATE bi-m1-jobs-to-be-done framework workflow. MUST read and follow ./phase-3/p3-3.task.md"
    status: completed
  - id: p3-4
    content: "p3-4: CREATE bi-m1-competitive-landscape framework workflow. MUST read and follow ./phase-3/p3-4.task.md"
    status: completed
  - id: p3-5
    content: "p3-5: CREATE bi-m1-problem-solution-fit framework workflow. MUST read and follow ./phase-3/p3-5.task.md"
    status: completed
  - id: p3-6
    content: "p3-6: CREATE bi-m1-lean-canvas framework workflow. MUST read and follow ./phase-3/p3-6.task.md"
    status: completed
  - id: p3-7
    content: "p3-7: CREATE bi-m1-five-whys framework workflow. MUST read and follow ./phase-3/p3-7.task.md"
    status: completed
  - id: p3-8
    content: "p3-8: CREATE M1 milestone workflow complete files (steps-c). MUST read and follow ./phase-3/p3-8.task.md"
    status: completed
  - id: p3-checkpoint
    content: P3 CHECKPOINT — Validate M1 conception milestone completeness
    status: pending
  - id: p4-1
    content: "p4-1: CREATE M2 milestone workflow. MUST read and follow ./phase-4/p4-1.task.md"
    status: completed
  - id: p4-2
    content: "p4-2: CREATE bi-m2-leap-of-faith framework workflow. MUST read and follow ./phase-4/p4-2.task.md"
    status: completed
  - id: p4-3
    content: "p4-3: CREATE bi-m2-assumption-mapping framework workflow. MUST read and follow ./phase-4/p4-3.task.md"
    status: completed
  - id: p4-4
    content: "p4-4: CREATE bi-m2-tam-sam-som framework workflow. MUST read and follow ./phase-4/p4-4.task.md"
    status: completed
  - id: p4-5
    content: "p4-5: CREATE bi-m2-unit-economics framework workflow. MUST read and follow ./phase-4/p4-5.task.md"
    status: completed
  - id: p4-6
    content: "p4-6: CREATE bi-m2-technology-readiness-level framework workflow. MUST read and follow ./phase-4/p4-6.task.md"
    status: completed
  - id: p4-7
    content: "p4-7: CREATE bi-m2-pre-mortem framework workflow. MUST read and follow ./phase-4/p4-7.task.md"
    status: completed
  - id: p4-8
    content: "p4-8: CREATE M2 milestone workflow complete files (steps-c). MUST read and follow ./phase-4/p4-8.task.md"
    status: completed
  - id: p4-checkpoint
    content: P4 CHECKPOINT — Validate M2 validation milestone completeness
    status: pending
  - id: p5-1
    content: "p5-1: CREATE M3 milestone workflow. MUST read and follow ./phase-5/p5-1.task.md"
    status: completed
  - id: p5-2
    content: "p5-2: CREATE bi-m3-brand-archetypes framework workflow. MUST read and follow ./phase-5/p5-2.task.md"
    status: completed
  - id: p5-3
    content: "p5-3: CREATE bi-m3-brand-prism framework workflow. MUST read and follow ./phase-5/p5-3.task.md"
    status: completed
  - id: p5-4
    content: "p5-4: CREATE bi-m3-golden-circle framework workflow. MUST read and follow ./phase-5/p5-4.task.md"
    status: completed
  - id: p5-5
    content: "p5-5: CREATE bi-m3-brand-positioning framework workflow. MUST read and follow ./phase-5/p5-5.task.md"
    status: completed
  - id: p5-6
    content: "p5-6: CREATE bi-m3-tone-of-voice framework workflow. MUST read and follow ./phase-5/p5-6.task.md"
    status: completed
  - id: p5-7
    content: "p5-7: CREATE bi-m3-messaging-architecture framework workflow. MUST read and follow ./phase-5/p5-7.task.md"
    status: completed
  - id: p5-8
    content: "p5-8: CREATE M3 milestone workflow complete files (steps-c). MUST read and follow ./phase-5/p5-8.task.md"
    status: completed
  - id: p5-checkpoint
    content: P5 CHECKPOINT — Validate M3 brand milestone completeness
    status: pending
  - id: p6-1
    content: "p6-1: Evaluate M4 Prototypation against BMAD workflows. MUST read and follow ./phase-6/p6-1.task.md"
    status: completed
  - id: p6-2
    content: "p6-2: Decide and document M4 integration scope. MUST read and follow ./phase-6/p6-2.task.md"
    status: completed
  - id: p6-3
    content: "p6-3: CREATE bi-m4 milestone workflow. MUST read and follow ./phase-6/p6-3.task.md"
    status: completed
  - id: p6-4
    content: "p6-4: CREATE bi-m4-user-flow-ia framework workflow. MUST read and follow ./phase-6/p6-4.task.md"
    status: completed
  - id: p6-5
    content: "p6-5: CREATE bi-m4-design-context bridge workflow. MUST read and follow ./phase-6/p6-5.task.md"
    status: completed
  - id: p6-6
    content: "p6-6: CREATE bi-m4-conversion-centered-design framework workflow. MUST read and follow ./phase-6/p6-6.task.md"
    status: completed
  - id: p6-7
    content: "p6-7: CREATE bi-m4-heuristic-evaluation framework workflow. MUST read and follow ./phase-6/p6-7.task.md"
    status: completed
  - id: p6-8
  ...
  - id: p6-9
    ...
    status: pending
  - id: p6-10
    content: "p6-10: CREATE bi-m5-mom-test framework workflow. MUST read and follow ./phase-6/p6-10.task.md"
    status: pending
  - id: p6-11
    content: "p6-11: CREATE bi-m5-spin-selling framework workflow. MUST read and follow ./phase-6/p6-11.task.md"
    status: pending
  - id: p6-12
    content: "p6-12: CREATE bi-m5-smoke-test framework workflow. MUST read and follow ./phase-6/p6-12.task.md"
    status: pending
  - id: p6-13
    content: "p6-13: CREATE bi-m5-van-westendorp framework workflow. MUST read and follow ./phase-6/p6-13.task.md"
    status: pending
  - id: p6-14
    content: "p6-14: CREATE bi-m5-bullseye framework workflow. MUST read and follow ./phase-6/p6-14.task.md"
    status: pending
  - id: p6-15
    content: "p6-15: CREATE bi-m5-sean-ellis-pmf framework workflow. MUST read and follow ./phase-6/p6-15.task.md"
    status: pending
  - id: p6-16
    content: "p6-16: UPDATE mentor agent for M5 routing logic. MUST read and follow ./phase-6/p6-16.task.md"
    status: pending
  - id: p6-17
    content: "p6-17: CREATE bi-m6 milestone workflow (minimal BMAD routing). MUST read and follow ./phase-6/p6-17.task.md"
    status: pending
  - id: p6-18
    content: "p6-18: UPDATE mentor agent for M6 routing logic to BMAD workflows. MUST read and follow ./phase-6/p6-18.task.md"
    status: pending
  - id: p6-19
    content: "p6-19: CREATE M4 milestone workflow complete files (steps-c). MUST read and follow ./phase-6/p6-19.task.md"
    status: completed
  - id: p6-20
    content: "p6-20: CREATE M5 milestone workflow complete files (steps-c). MUST read and follow ./phase-6/p6-20.task.md"
    status: pending
  - id: p6-21
    content: "p6-21: CREATE M6 milestone workflow complete files (steps-c). MUST read and follow ./phase-6/p6-21.task.md"
    status: pending
  - id: p6-checkpoint
    content: P6 CHECKPOINT — Confirm all milestones addressed with BMAD integration
    status: pending
  - id: p7-refs
    content: "p7-refs: File reference review. MUST read and follow ./phase-7/p7-refs.task.md"
    status: pending
  - id: p7-compound
    content: "p7-compound: Compound learnings into system improvements. MUST read and follow ./phase-7/p7-compound.task.md"
    status: pending
  - id: p7-checkpoint
    content: P7 FINAL CHECKPOINT — User approval to complete plan
    status: pending
isProject: false
---
...
flowchart TD
    ...
    subgraph P2[Phase 2: Master Workflow]
        p2_1[workflow.md]
        p2_2[Knowledge]
        p2_3[Steps]
        p2_cp{P2 Checkpoint}
    ...
    subgraph P3[Phase 3: M1 Conception]
        p3_1[bi-m1]
        p3_2[6 Frameworks]
        p3_cp{P3 Checkpoint}
    end
    
    subgraph P4[Phase 4: M2 Validation]
        p4_1[bi-m2]
        p4_2[6 Frameworks]
        p4_cp{P4 Checkpoint}
    end
    
    subgraph P5[Phase 5: M3 Brand]
        p5_1[bi-m3]
        p5_2[6 Frameworks]
        p5_cp{P5 Checkpoint}
    end
    
    subgraph P6[Phase 6: M4-M6 Evaluation]
        p6_eval[Evaluate]
        p6_impl[Implement]
        p6_cp{P6 Checkpoint}
    end
    
    subgraph P7[Phase 7: Finalize]
        p7_refs[References]
        p7_compound[Compound]
        p7_cp{Final Checkpoint}
    end
    
    p1_1 --> p1_2 --> p1_3 --> p1_cp
    p1_cp --> p2_1 --> p2_2 --> p2_3 --> p2_cp
    p2_cp --> p3_1 --> p3_2 --> p3_cp
    p3_cp --> p4_1 --> p4_2 --> p4_cp
    p4_cp --> p5_1 --> p5_2 --> p5_cp
    p5_cp --> p6_eval --> p6_impl --> p6_cp
    p6_cp --> p7_refs --> p7_compound --> p7_cp
```
