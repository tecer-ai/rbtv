...
Delete the obsolete `rbtv-manifest.csv` after p3-3 confirms no remaining references.
...
2. Confirm the file no longer exists at `rbtv-manifest.csv`.
...
|--------|----------|--------|
| Deleted file | `rbtv-manifest.csv` removed | N/A |
