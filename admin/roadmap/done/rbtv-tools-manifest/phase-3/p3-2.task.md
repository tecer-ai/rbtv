...
| `workflows/doc-context-handoff/steps-c/step-03-extraction.md` | File to update |
| `tasks/quality-review.xml` | Renamed task file (verify exists from p3-1) |
...
|--------|----------|--------|
| Updated extraction step | `workflows/doc-context-handoff/steps-c/step-03-extraction.md` | Markdown |
