...
| `workflows/plan-lifecycle/steps-c/step-04-generate-artifacts.md` | File to update |
...
1. Add instruction that when generating the Tools section, agents must consult `tools-manifest.csv` for the complete list of available tool ids and paths.
...
|--------|----------|--------|
| Updated step file | `workflows/plan-lifecycle/steps-c/step-04-generate-artifacts.md` | Markdown |
