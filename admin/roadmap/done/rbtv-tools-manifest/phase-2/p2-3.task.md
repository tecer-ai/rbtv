...
| `workflows/plan-lifecycle/templates/plan-task-microstep-template.md` | File to update |
...
1. Add instruction to the Tools section: "Available tools: see `tools-manifest.csv` for the complete list of skills and subagents with their ids and paths."
...
|--------|----------|--------|
| Updated template | `workflows/plan-lifecycle/templates/plan-task-microstep-template.md` | Markdown |
