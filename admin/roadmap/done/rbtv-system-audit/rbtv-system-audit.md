...
2. For links to `BMAD/`, check against the mirrored documentation in `_admin/docs/BMAD-mirror/`
...
**Output:** Document analysis in commit message or create `_admin/docs/analysis/mentor-continuity-review.md` if findings are extensive
...
### TASK 7: Execute PRDs in `_admin/docs/todos/`
**Objective:** Implement the 2 PRDs located in `_admin/docs/todos/`

**Steps:**
1. Read `_admin/docs/todos/cp-bmad-domain-and-manifests.md`
2. Read `_admin/docs/todos/cp-shape_discovery_propagation.md`
3. For each PRD:
...
Refs: _admin/docs/todos/[prd-filename]
Task 7: Execute PRDs
```
...
Action: [changes made OR PRD created at _admin/docs/todos/]
...
4. For components meeting substitution threshold:
   - Create individual PRD in `_admin/docs/todos/`
...
3. Create issue in `_admin/docs/todos/` for manual resolution
