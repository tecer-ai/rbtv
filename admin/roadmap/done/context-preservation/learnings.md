...
**Learning:** Replication to workspace locations (`.cursor/rules/`, `.cursor/skills/`) is an installer/bootstrap responsibility. Plan tasks must write only to the canonical source (`_config/claude/rules/`, etc.).
