...
- `workflows/bi-business-innovation/workflow.md` — frontmatter `outputFolder`, any `{project-root}` references
- `workflows/bi-business-innovation/steps-c/step-02-project-setup.md` — `outputFolder`, `outputFolder/`
- `workflows/bi-business-innovation/steps-c/step-03-milestone-select.md` — `projectMemo`
- `workflows/bi-business-innovation/data/founder-process.md` — `projects/`, `project-memo`, output folder structure
- `workflows/bi-business-innovation/bi-m1/workflow.md` — frontmatter `outputFolder`
- `workflows/bi-business-innovation/bi-m2/workflow.md` — frontmatter `outputFolder`
- `workflows/bi-business-innovation/bi-m3/workflow.md` — frontmatter `outputFolder`
- `workflows/bi-business-innovation/bi-m4/workflow.md` — frontmatter `outputFolder`

**Framework workflows (every `workflow.md` under bi-m1-*, bi-m2-*, bi-m3-*, bi-m4-*):**

- `workflows/bi-business-innovation/bi-m1/bi-m1-*/workflow.md`
- `workflows/bi-business-innovation/bi-m2/bi-m2-*/workflow.md`
- `workflows/bi-business-innovation/bi-m3/bi-m3-*/workflow.md`
- `workflows/bi-business-innovation/bi-m4/bi-m4-*/workflow.md`
...
1. **In IDE:** File content search (e.g. Cursor Search, grep) in folder `workflows/`.
...
- Search for: `outputFolder:` or `projectMemo:` in `workflows/`.
...
**Files Modified:** workflows/bi-business-innovation/bi-m4/workflow.md, workflows/bi-business-innovation/bi-m4/bi-m4-user-flow-ia/steps-c/step-04-synthesis.md
...
**Files Modified:** workflows/bi-business-innovation/bi-m4/workflow.md
...
- workflows/bi-business-innovation/bi-m4/workflow.md
- workflows/bi-business-innovation/bi-m4/bi-m4-user-flow-ia/steps-c/step-04-synthesis.md
- workflows/bi-business-innovation/bi-m4/bi-m4-design-context/ (5 files created)
