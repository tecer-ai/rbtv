...
inputDocuments:
  ...
  - 'workflows/bi-business-innovation/templates/project-memo.md'
  - 'workflows/bi-business-innovation/steps-c/step-01-project-setup.md'
...
| File | Issue |
|------|-------|
| `workflows/bi-business-innovation/templates/project-memo.md` | Missing `## Canonical Assumption Inventory` section. Each framework's template has its own assumptions section, but the project-memo (the single source of truth for project state) has no consolidated view. |
| `workflows/bi-business-innovation/steps-c/step-01-project-setup.md` | Creates the output folder — currently uses `founder/` as the subfolder name. |
| `workflows/bi-business-innovation/workflow.md` | References `founder/` in output path documentation. |
...
Add the following section to `workflows/bi-business-innovation/templates/project-memo.md` after the Progress section:
...
| Aspect | Details |
|--------|---------|
| File(s) to modify | `workflows/bi-business-innovation/templates/project-memo.md` (add canonical assumptions section) |
| | `workflows/bi-business-innovation/steps-c/step-01-project-setup.md` (rename `founder/` → `business-innovation/`) |
| | `workflows/bi-business-innovation/workflow.md` (update output path references) |
...
| File | Relationship |
|------|--------------|
| `workflows/bi-business-innovation/templates/project-memo.md` | Primary target — template to modify |
| `workflows/bi-business-innovation/steps-c/step-01-project-setup.md` | Target — folder creation logic |
| `workflows/bi-business-innovation/workflow.md` | Target — output path documentation |
