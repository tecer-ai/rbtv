...
|------------|--------|--------|
| `` is a git repo | Repository structure | All moves MUST use `git mv` |
...
**Old path:** `workflows/bi-business-innovation/workflow.md`
**No change** — master folder didn't move.

### Pattern J: `mentor-help.xml` dynamic paths

**Old:** `{project-root}/workflows/bi-m{N}/workflow.md`
**New:** `{project-root}/workflows/bi-business-innovation/bi-m{N}/workflow.md`
