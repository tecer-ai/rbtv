...
1. Read the reference (e.g., `{project-root}/bmm/workflows/create-prd/workflow.md`)
...
When Ana's PRD workflow referenced `{project-root}/bmm/workflows/2-plan-workflows/create-prd/workflow.md`, the agent:
...
|---|---|
| `{project-root}/core/...` | ~55 files |
| `{project-root}/bmm/...` | ~6 files |
| `{project-root}/...` (self-resolves) | Most files |
| `{project-root}/projects/...` | Config + workflows |

Every cross-module reference (core, bmm) requires the 5-step resolution process. Self-references (``) are simpler but still require checking against the table to confirm the rule.
...
paths:
  bmad_core: "{project-root}/core"
  bmad_bmm: "{project-root}/bmm"
  bmad_rbtv: "{project-root}/rbtv"
...
```yaml
paths:
  bmad_core: "_admin/docs/BMAD-mirror/core"
  bmad_bmm: "_admin/docs/BMAD-mirror/bmm"
  bmad_rbtv: "."
...
```
exec="{project-root}/core/workflows/party-mode/workflow.md"
