...
| `_admin/docs/BMAD-mirror/_config/manifest.yaml` | BMAD installation manifest — version `6.0.0-Beta.4` | Inside read-only mirror; RBTV never reads this |
...
| `_admin/docs/BMAD-mirror/_config/manifest.yaml` | Source of current BMAD version (read-only) |
...
|---------|--------|-------------|
| Beta.5 | Fix leaked source paths → `{project-root}/core/` | RBTV uses same path pattern — confirms alignment |
...
- `{project-root}/bmm/workflows/1-analysis/create-product-brief/workflow.md`
- `{project-root}/bmm/workflows/2-plan-workflows/create-prd/workflow.md`
- `{project-root}/bmm/workflows/2-plan-workflows/create-ux-design/workflow.md`
