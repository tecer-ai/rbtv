...
| Related files | `bmm/config.yaml`; `_config/config.yaml`; `workflows/doc-compound-learning/workflow.md` |
...
| `bmm/config.yaml` | Defines path templates consumed by planning workflows |
