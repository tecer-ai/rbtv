...
inputDocuments: ['agents/leo.md', 'agents/roelof.md', 'agents/vivian.md', 'workflows/pitch/steps-e/step-e01-load.md', 'workflows/pitch/steps-e/step-e02-edit.md', 'workflows/pitch/steps-c/step-07-generate.md']
...
| File | Status | Issue |
|------|--------|-------|
| `agents/leo.md` | Loaded, followed | No sync rule exists |
| `agents/roelof.md` | Not in session | Same gap — no sync rule |
| `agents/vivian.md` | Not in session | Has "take narrative as INPUT" rule but no bidirectional sync |
| `workflows/pitch/steps-e/step-e01-load.md` | Loaded, followed | Loads HTML only. Does not load narrative. |
| `workflows/pitch/steps-e/step-e02-edit.md` | Not loaded | Likely same gap |
| `workflows/pitch/steps-c/step-07-generate.md` | Not loaded | No sync instruction after HTML generation |
...
3. **Update System File**: Add sync rule to each agent's `<rules>` section ★ SELECTED
   ...
   - **Location:** `agents/leo.md`, `roelof.md`, `vivian.md`
...
| Aspect | Details |
|--------|---------|
| File(s) to modify | `agents/leo.md` (add 1 rule) |
| | `agents/roelof.md` (add 1 rule) |
| | `agents/vivian.md` (add 1 rule, modify 1 rule) |
| | `workflows/pitch/steps-e/step-e01-load.md` (add section 2b) |
| | `workflows/pitch/steps-e/step-e02-edit.md` (add sync enforcement section) |
| | `workflows/pitch/steps-c/step-07-generate.md` (add post-generation sync check) |
...
| File | Relationship |
|------|--------------|
| `agents/leo.md` | Pitch agent — add sync rule |
| `agents/roelof.md` | Pitch agent — add sync rule |
| `agents/vivian.md` | Pitch agent — add sync rule, modify INPUT rule |
| `workflows/pitch/steps-e/step-e01-load.md` | Edit workflow — add narrative loading |
| `workflows/pitch/steps-e/step-e02-edit.md` | Edit workflow — add sync enforcement |
| `workflows/pitch/steps-c/step-07-generate.md` | Create workflow — add post-generation sync check |
| `workflows/pitch/steps-c/step-03-narrative.md` | Create workflow — produces the narrative (no changes needed) |
...
- Pattern reference: existing agent `<rules>` sections in `agents/*.md`
- Pattern reference: existing step-specific rules in `workflows/pitch/steps-e/*.md`
