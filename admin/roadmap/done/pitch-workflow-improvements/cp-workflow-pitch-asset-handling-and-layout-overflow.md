...
inputDocuments:
  - 'workflows/pitch/steps-c/step-07-generate.md'
  - 'workflows/_shared/pitch-data/html-patterns.md'
  - 'workflows/_shared/pitch-data/html-components.md'
outputPath: '_admin/roadmap/todos/_claude-code-workspace/pitch-workflow'
date: '2026-03-17'
yoloMode: false
---
...
| Aspect | Details |
|--------|---------|
| File(s) to modify | `workflows/_shared/pitch-data/html-patterns.md`, `workflows/pitch/steps-c/step-07-generate.md` |
...
| File | Relationship |
|------|--------------|
| `workflows/_shared/pitch-data/html-patterns.md` | Primary target — receives logo, background, and constraint additions |
| `workflows/pitch/steps-c/step-07-generate.md` | Secondary target — verification table update |
| `workflows/_shared/pitch-data/html-components.md` | May want a logo component entry in the future |
