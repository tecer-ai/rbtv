...
>
> - `workflows/pitch/data/html-patterns.md` — added Logo Pattern section, Background Image Pattern section, Design Constraints rows 13–16
> - `workflows/pitch/steps-c/step-07-generate.md` — added content-fit validation and logo-rendering verification rows
>
> ## Quality Criteria
>
...
>
> - UPDATED: `workflows/pitch/steps-c/step-01-init.md` — output path prompt with folder conventions, defaults, and user approval
> - CREATED: `workflows/pitch/steps-c/step-10-pdf-validation.md` — Decktape export + Playwright QA loop
> - UPDATED: `workflows/pitch/steps-c/step-09-synthesis.md` — chains to step-10
> - UPDATED: `workflows/pitch/workflow.md` — registers step-10
>
> ## Quality Criteria
>
...
>
> - UPDATED: `agents/leo.md` — artifact sync rule in `<rules>`
> - UPDATED: `agents/roelof.md` — artifact sync rule in `<rules>`
> - UPDATED: `agents/vivian.md` — artifact sync rule + INPUT rule update
> - UPDATED: `workflows/pitch/steps-e/step-e01-load.md` — loads narrative and companion docs
> - UPDATED: `workflows/pitch/steps-e/step-e02-edit.md` — sync enforcement after content edits
> - UPDATED: `workflows/pitch/steps-c/step-07-generate.md` — post-generation sync check
>
> ## Quality Criteria
>
