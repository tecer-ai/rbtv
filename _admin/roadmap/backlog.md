...
> Total PRDs: 14 | Compounds: 8

---

## Update Instructions

**When updating this file, do the following:**

1. **Glob** `_admin/roadmap/**/prd-*.md`, `_admin/roadmap/**/cp-*.md`, `_admin/roadmap/**/*.plan.md`.
2. **Group** items by containing folder. Items in the same folder MUST appear together in one section.
3. **For each file:** Read it and extract or preserve Description, Goals, Scope, Dependencies. Update the File path if the file moved.
4. **Update** `Generated` to today's date; recalculate PRD/Compound counts.
5. **Keep** the Summary table, Dependency Chain, and folder-section structure. Add new items; remove items whose files no longer exist.

---

## Summary

| # | Group | PRD | Priority | Type | Scope |
|---|-------|-----|----------|------|-------|
| 1 | (root) | Git PR Mode | High | Workflow | Small |
| 20 | (root) | Visual Design Extraction — Live Site Navigation & Multi-Page Token Extraction | High | Workflow | Large |
| 2 | bi-workflow/ | Mentor Help Mode | High | Agent Enhancement | Small |
| 3 | bi-workflow/ | Business Innovation Migration | High | Workflow + Agent | Large |
| 14 | bi-workflow/ | BI Workflow Default Structures | Medium | Workflow | Moderate |
| 15 | bi-workflow/ | Cross-Framework Consistency Gate | Medium | Workflow | Minimal |
| 10 | plan-workflow/ | Checkpoint HALT Enforcement | Low | Process | Minimal |
...
| 11 | rbtv-system-consistency/ | Workflow Continuation Compliance | Low | Workflow Enhancement | Large |
| 13 | rbtv-system-consistency/ | Agent Menu Externalization Rule | Low | Process | Minimal |
...
**File:** `todos/prd-git-sq-pr-merge-mode.md`
**Type:** Workflow
...
**File:** `todos/cp-visual-design-extraction-live-site-access.md`
**Type:** Workflow
...
**File:** `todos/bi-workflow/prd-mentor-help-mode.md`
...
**File:** `todos/bi-workflow/founder-to-bi-migration/business-innovation-migration_v3.plan.md`
**Type:** Workflow + Agent
...
**File:** `todos/bi-workflow/cp-workflow-bi-default-structures.md`
**Type:** Workflow
...
**File:** `todos/bi-workflow/cp-workflow-bi-cross-framework-consistency-gate.md`
**Type:** Workflow
...
**File:** `todos/plan-workflow/prd-plan-checkpoint-halt.md`
...
**File:** `todos/plan-workflow/cp-plan-checkpoint-quality-review-subagent-mandate.md`
**Type:** Workflow
...
**File:** `todos/plan-workflow/cp-plan-linking-standard-internal-relative-external-alias.md`
**Type:** Workflow
...
### 21. Plan Template Context Optimization
**File:** `todos/plan-workflow/cp-plan-template-context-optimization.md`
**Type:** Workflow + Template
**Description:** The plan template produces plan files with systematic content duplication. Generated plans repeat task descriptions, decisions, and file dependencies that already exist in companion files (shape.md, microstep tasks, YAML frontmatter), wasting tokens and crowding the context window.
**Goals:** Reduce plan body redundancy by referencing companion files instead of duplicating content; keep plan self-contained enough for checkpoint/execution use. Token and context-window optimization.
**Scope:** Moderate — plan template restructure, workflow rules update.
**Dependencies:** None.
...
## todos/bmad-integration/

### 8. BMAD Delegation Standards and Optional Analyst at M2
**File:** `todos/bmad-integration/prd-bmad-analyst-delegation-at-m2.md`
...
**File:** `todos/bmad-integration/prd-integrate-advanced-elicitation.md`
**Type:** Integration
...
## todos/rbtv-system-consistency/

### 9. PRD Option Evaluation -- Format Consistency Criterion
**File:** `todos/rbtv-system-consistency/prd-consistency-criterion.md`
**Type:** Process Improvement
...
**File:** `todos/rbtv-system-consistency/prd-workflow-continuation-compliance.md`
...
**File:** `todos/rbtv-system-consistency/prd-agent-menu-externalization-rule.md`
**Type:** Process Improvement
...
## testing/optimize-nanobot-token-usage/

### 18. Nanobot Token Optimization — Prompt Caching & Model Routing
**File:** `testing/optimize-nanobot-token-usage/cp-nanobot-token-optimization-prompt-caching.md`
**Type:** System File
