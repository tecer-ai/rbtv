...
touchpoints:
  ...
  structure_assumptions:
    ...
    - item: "_bmad/_config/manifest.yaml"
      description: "BMAD installation manifest with version field"
    - item: "_bmad/core/config.yaml structure"
...
2. Read target BMAD project's `_bmad/_config/manifest.yaml`
