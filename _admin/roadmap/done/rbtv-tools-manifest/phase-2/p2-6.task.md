...
| `_bmad/rbtv/get_started.md` | File to update |
...
1. Add manifest location: `_bmad/rbtv/tools-manifest.csv` as the canonical list of all available tools.
...
|--------|----------|--------|
| Updated get_started | `_bmad/rbtv/get_started.md` | Markdown |
