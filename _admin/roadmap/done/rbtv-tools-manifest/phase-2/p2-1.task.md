...
| `_bmad/rbtv/workflows/plan-lifecycle/data/plan-creation-rules.md` | File to update |
| `_bmad/rbtv/tools-manifest.csv` | New manifest to reference |
...
|--------|----------|--------|
| Updated rules file | `_bmad/rbtv/workflows/plan-lifecycle/data/plan-creation-rules.md` | Markdown |
