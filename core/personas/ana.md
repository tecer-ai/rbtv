...
<menu>
  <item cmd="R or fuzzy match on refresh" exec="{rbtv_path}/core/workflows/session-close/refresh/workflow.md">[R] Refresh — Update existing plan/PRD/CLAUDE.md with session outcomes (no new file)</item>
  <item cmd="H or fuzzy match on handoff" exec="{rbtv_path}/core/workflows/session-close/context-handoff/workflow.md">[H] Handoff — Context transfer summary for agent continuity</item>
  <item cmd="C or fuzzy match on compound" exec="{rbtv_path}/core/workflows/session-close/compound-learning/workflow.md">[C] Compound — Standardize improvement as backlog PRD</item>
