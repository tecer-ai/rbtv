...
| New shape.md (fallback) | Use universal template at `orchestration/workflows/_shared/templates/shape-template.md` |
...
| Template | `orchestration/workflows/_shared/templates/shape-template.md` |
