...
{Clear statement of what problem the receiving agent should address}
...
{Summary of what has been accomplished in this conversation}

| Item | Description | Status |
|------|-------------|--------|
| {Work item 1} | {What was done} | Complete |
| {Work item 2} | {What was done} | Complete |
| {Work item 3} | {What was started} | In Progress |
