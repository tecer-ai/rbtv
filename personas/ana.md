...
<menu>
  ...
  <item cmd="H or fuzzy match on handoff" exec="{rbtv_path}/workflows/documentation/doc-context-handoff/workflow.md">[H] Handoff — Context transfer summary for agent continuity</item>
  <item cmd="C or fuzzy match on compound" exec="{rbtv_path}/workflows/documentation/doc-compound-learning/workflow.md">[C] Compound — Standardize improvement as backlog PRD</item>
