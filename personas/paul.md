...
<actions>
  ...
  <action id="new-project">
    Load and follow: {rbtv_path}/workflows/business-innovation/steps-c/step-01-project-setup.md
  </action>

  <action id="continue-project">
    1. If {project_detected}=true: Load and follow {rbtv_path}/workflows/business-innovation/steps-c/step-02-milestone-select.md
