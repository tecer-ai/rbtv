...
knowledgeFolder: "{rbtv_path}/workflows/component-creation/data"
templatesFolder: "{rbtv_path}/workflows/component-creation/templates"
---
...
<menu-handlers>
  <handlers>
    ...
    <handler type="template">
      ...
      2. If building skills (CI menu item), also load and follow `workflows/ai-consulting/prompting-assistance/data/platform_knowledge/claude_skills.md`
