...
- **Inputs / outputs**:
  ...
  - Output: in-place execution of the plan via sub-agents, plus a final message per `templates/finalization-message-template.md` covering status, batch summary, next actions, low-confidence decisions worth review (autonomous mode), and artifact links
