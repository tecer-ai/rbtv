...
> Instruct the user:
>
> *"Brand Identity is locked. Visual Guidelines — color palette, typography, logo, imagery, and iconography — require the design agent. To continue, invoke the `rbtv-designing` skill (Vivian) and select **[BV] Brand Visual Identity**. She'll build the visual identity grounded in the brand frameworks we just compiled."*
>
