...
1. Read the content ownership mapping in `{rbtv_path}/innovation/workflows/business-innovation/data/founder-process.md` for M1.
...
### 6. Update competitive-landscape.md
