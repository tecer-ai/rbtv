...
<menu>
  ...
  <item cmd="H or fuzzy match on help, where, status, progress, overview" exec="{rbtv_path}/innovation/tasks/innovator-help.xml">[H] Help: Show milestone position and framework progress</item>
...
<actions>
  ...
  <action id="new-project">
    Load and follow: {rbtv_path}/innovation/workflows/business-innovation/steps-c/step-01-project-setup.md
  </action>

  <action id="continue-project">
    1. If {project_detected}=true: Load and follow {rbtv_path}/innovation/workflows/business-innovation/steps-c/step-02-milestone-select.md
