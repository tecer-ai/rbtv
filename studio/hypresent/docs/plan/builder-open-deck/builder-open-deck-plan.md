...
- [x] `p3-checkpoint` **CHECKPOINT** — full restructure loop: open → reorder/remove/duplicate/add → save → reopen intact → `phase-3/p3-checkpoint.task.md`
...
- [x] `p4-checkpoint` **CHECKPOINT** — round trip builder↔editor without losing work → `phase-4/p4-checkpoint.task.md`
