...
| Task | Artifact | Path | Status |
|------|----------|------|--------|
| p4-1 | Save-and-switch controls both directions + e2e | `app/js/builder/builder-main.js`, `app/builder.html`, `app/js/main.js`, `app/index.html`, `app/js/shell/file-controls.js`, `tests/e2e/test_pb12_bridge.py` | pending |
