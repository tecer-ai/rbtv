...
All configuration inherited from `_bmad/rbtv/_config/config.yaml`:
- `user_name`
...
| Config | Inherited | Uses `_bmad/rbtv/_config/config.yaml` |
...
| Reference | Path |
|-----------|------|
| Module config | `_bmad/rbtv/_config/config.yaml` |
