<!-- AUTO-GENERATED — DO NOT EDIT. Rendered by orchestration/models/render-manuals.py from orchestration/skills/orchestrating/cards/dispatch-wrapper.md + orchestration/models/codex/delta.md. -->
...
> - the `codex` package delta `orchestration/models/codex/delta.md`.
>
...
> codex-specific behavior, edit the delta. Then re-render:
>
> ```
