<!-- AUTO-GENERATED — DO NOT EDIT. Rendered by orchestration/models/render-manuals.py from orchestration/skills/orchestrating/cards/dispatch-wrapper.md + orchestration/models/gemini-api/delta.md. -->
...
> - the `gemini-api` package delta `orchestration/models/gemini-api/delta.md`.
>
...
> gemini-api-specific behavior, edit the delta. Then re-render:
>
> ```
