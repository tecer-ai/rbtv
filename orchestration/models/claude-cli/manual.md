<!-- AUTO-GENERATED — DO NOT EDIT. Rendered by orchestration/models/render-manuals.py from orchestration/skills/orchestrating/cards/dispatch-wrapper.md + orchestration/models/claude-cli/delta.md. -->
...
> - the `claude-cli` package delta `orchestration/models/claude-cli/delta.md`.
>
...
> claude-cli-specific behavior, edit the delta. Then re-render:
>
> ```
