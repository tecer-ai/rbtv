<!-- AUTO-GENERATED MIRROR — DO NOT EDIT. Generated by rbtv mirror.py from CLAUDE.md. -->

> [!danger] GENERATED FILE — DO NOT EDIT
> This `QWEN.md` is an auto-generated mirror of `CLAUDE.md`, emitted for the Qwen Code CLI worker.
> Hand-edits are overwritten on the next mirror run and are forbidden. To change
> these instructions, edit `CLAUDE.md` and re-run the mirror:
>
> ```
