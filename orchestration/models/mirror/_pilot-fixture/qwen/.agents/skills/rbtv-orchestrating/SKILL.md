...
1. Read `3-resources/tools/rbtv/orchestration/skills/orchestrating/core-protocol.md` IN FULL and keep it in context for the whole run. It carries the invariants, the situation table, and the installed-model capability summary.
