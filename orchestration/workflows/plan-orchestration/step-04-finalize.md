...
Read `{rbtv_path}/orchestration/workflows/plan-orchestration/templates/finalization-message-template.md`. This template defines the required sections and ordering.
