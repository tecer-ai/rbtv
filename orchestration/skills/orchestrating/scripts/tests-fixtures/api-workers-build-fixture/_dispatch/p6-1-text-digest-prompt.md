...
## SOURCE 1: decisions.md (verbatim)
...
## SOURCE 2: deliverables.md (verbatim)
...
| p1-checkpoint | DeepSeek pilot evidence + approval | `1-projects/rbtv-evolution/coding/done-gate-evidence/rbtv/2026-08-...→2026-06-08-api-deepseek-pilot.md` | ✅ PASSED + approved 2026-06-09 (builder 7/7 + cold-verify 6/6) |
...
| Task | Artifact | Path | Status |
|------|----------|------|--------|
| p3-1 | Agent-tool Claude package | `…/orchestration/models/claude/{manifest.yaml,delta.md}` | ✅ committed cad73ef |
| p3-2 | Routing card: selector + carrier + API hooks | `…/orchestration/skills/orchestrating/cards/routing.md` | ✅ committed cad73ef |
| p3-3 | Intake card: pair-enumerated budget summary | `…/orchestration/skills/orchestrating/cards/intake.md` | ✅ committed af494e1 |
| p3-checkpoint | Determinism + no-collapse evidence + approval | `1-projects/rbtv-evolution/coding/done-gate-evidence/rbtv/2026-06-09-deterministic-routing.md` | ✅ APPROVED 2026-06-09 (7/7 HELD, builder+cold-verify agree; Key-5 applied bafef3e) |
...
| Task | Artifact | Path | Status |
|------|----------|------|--------|
| p6-1 | Live-pilot evidence + earn-their-keep verdict | `1-projects/rbtv-evolution/coding/done-gate-evidence/rbtv/2026-06-09-orchestrated-pilot/` | in-progress |
| p6-refs | Link-check result + fixes | `./` (in-place) | pending |
| p6-compound | Compound PRDs (if any) + processed learnings | `.user/compounds/orchestration/` + `./learnings.md` | pending |
| p6-checkpoint | Final approval + exit scorecard | `./decisions.md` (Decision entry) | pending |
