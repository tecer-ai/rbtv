...
| Prompting knowledge (shared) | `{rbtv_path}/workflows/ai-consulting/prompting-assistance/data/` — model docs, techniques, platform knowledge |
...
2. Load the first step file and follow its instructions exactly.
