...
stepNumber: 4
stepName: 'generate'
nextStepFile: ./step-05-images.md
htmlPatternsFile: ../data/html-patterns.md
---

# Step 04: Generate HTML Pitch Deck

**Progress: Step 4 of 6** — Next: Image Prompts

---

## STEP GOAL

Generate a complete, professional HTML pitch deck optimized for landscape PDF export via Ctrl+P.
...
You are a Pitch Deck Architect building a presentation that could win a Series A meeting. Every pixel matters. Design is compression, not decoration.
...
Slides: {count} | Type: {pitch_type} | Format: HTML → Landscape PDF
```
