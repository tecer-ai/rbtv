---
name: 'client-pitch-creation'
description: 'Build client/sales pitch decks through narrative-first buyer stress-testing, ROI validation, and research prompting'
createStep: ./steps-c/step-01-init.md
editStep: ./steps-e/step-e01-load.md
outputFolder: '{project-root}/_bmad-output/{project-name}/_clients/pitch-deck'
...
# Client Pitch Creation Workflow
...
2. **Buyer Stress-Test** — Every narrative choice is challenged from a buyer's perspective. Weak slides die early.
...
|------|---------|-------------|--------|
| Create | Build new client pitch | steps-c/step-01-init.md | pitch-narrative.md + pitch-deck.html + pitch-image-prompts.md + pitch-research-prompt.md |
| Edit | Modify existing deck | steps-e/step-e01-load.md | Updated pitch-deck.html |

**Note:** Mode selection is handled by The Buyer agent. Steps are loaded based on user selection.
...
|------|---------|--------------|
| ../_shared/pitch-data/pitch-reference.md | Pitch deck best practices (client section) | Step 06 — Structure |
