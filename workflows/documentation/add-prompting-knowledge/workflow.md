...
```
Route to: {rbtv_path}/personas/fernando.md
...
- Output location: {rbtv_path}/workflows/ai-consulting/prompting-assistance/data/{ai_models|prompting_techniques|platform_knowledge}/
```

**Template Sources:**
- AI Model: `{rbtv_path}/workflows/ai-consulting/prompting-assistance/data/ai_model.md`
- Prompting Technique: `{rbtv_path}/workflows/ai-consulting/prompting-assistance/data/prompting_technique.md`
- Platform Knowledge: `{rbtv_path}/workflows/ai-consulting/prompting-assistance/data/platform_knowledge.md`
...
> `{rbtv_path}/workflows/ai-consulting/prompting-assistance/data/knowledge-index.csv`
>
> Format:
