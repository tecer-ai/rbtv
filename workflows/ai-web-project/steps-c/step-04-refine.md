...
| 7 | **Platform fit** | Does the prompt respect platform constraints (char limits, file references)? |
...
> 3. Paste contents of `instructions.md` into the Instructions field
> 4. Upload any companion files
> 5. Test with a sample conversation

**Claude:**
> 1. Go to claude.ai → Projects
> 2. Create new project
> 3. Paste contents of `instructions.md` into Project Instructions
> 4. Upload any companion files to Project Knowledge
> 5. Test with a sample conversation
...
> 2. Create new project
> 3. Paste contents of `instructions.md` into the master instructions
> 4. Upload any companion files to the project knowledge base
