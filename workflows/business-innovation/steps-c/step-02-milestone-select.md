...
1. Resolve the workflow path for the target milestone (replace `../` with the actual path from `{rbtv_path}/workflows/business-innovation/` so that bi-m1 → `{rbtv_path}/workflows/business-innovation/bi-m1/workflow.md`).
