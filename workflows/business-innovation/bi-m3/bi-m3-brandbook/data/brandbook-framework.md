...
3. **Load** model/platform knowledge from DomCobb's prompting knowledge index at `{rbtv_path}/workflows/ai-consulting/prompting-assistance/data/knowledge-index.csv`
