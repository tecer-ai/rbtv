---
name: Web Search
description: Navigate the web — preview link metadata, extract clean content from URLs, and conduct rigorous multi-source research with source evaluation and citation standards.
---
...
Read `{rbtv_path}/workflows/web-search/data/web-research-standards.md`. Internalize all rules: data integrity, quantification, source evaluation, citation format, tone.
