---
description: Agent CLI Patterns — create-cli capability reference
tags: [planning]
---

# Agent CLI Patterns

Use this reference when designing the command surface for a new CLI an agent should run.

## Mental model

The CLI is the agent's command layer. It should turn a service, app, API, log source, or database into shell commands an agent can run repeatedly from any repo.
