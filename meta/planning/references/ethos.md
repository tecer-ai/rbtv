---
description: the shared design ethos — the canonical block every carrying prompt copies verbatim into its constraints section
tags: [planning]
---

# design ethos — one home, copied verbatim
