...
1. LOAD the FULL agent file from {rbtv_path}/{module}/personas/{agent-id}.md
...
Load and follow: `{rbtv_path}/{module}/{type}/{path}`
```
...
**IMMEDIATELY** load and execute: `{rbtv_path}/{module}/{type}/{path}`
