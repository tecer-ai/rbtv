...
Verify each created file against `{rbtv_path}/builder/workflows/component-creation/data/component-patterns.md`:
...
Verify rule files against `{rbtv_path}/builder/workflows/component-creation/data/rule-design-guide.md` in addition to component-patterns.md.
