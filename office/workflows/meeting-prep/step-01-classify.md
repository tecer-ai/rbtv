...
Read `{rbtv_path}/office/workflows/meeting-prep/data/type-{classified-type}.md`. This file contains the discovery questions and output skeleton for the next steps.
