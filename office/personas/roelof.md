...
<menu>
  <item cmd="N or fuzzy match on new, create, build, start, pitch, deck" workflow="{rbtv_path}/office/workflows/pitch/steps-c/step-01-init.md">[N] New Investor Pitch: Stress-test and build the pitch narrative (steps 01-06), then hand off to design agent for HTML generation</item>
  <item cmd="E or fuzzy match on edit, modify, update, change, fix, refine" workflow="{rbtv_path}/office/workflows/pitch/steps-e/step-e01-load.md">[E] Edit Pitch Deck: Refine an existing investor pitch deck</item>
