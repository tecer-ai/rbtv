...
// from the BOOT-READ MERGED CONFIG (`envelope/spawn-profiles.yaml` → `loadMergedConfig`, no
...
// `supervisor/spawn/spawn.js` can ask this same question of a different containment — a specific
...
module.exports = {
  ...
  // Exported for the seat-cage grant resolvers (`supervisor/spawn/spawn.js`), which must answer the
