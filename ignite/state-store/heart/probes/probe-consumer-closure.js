...
const IGNITE = (() => {
  ...
  if (path.basename(byProperty) !== 'ignite'
      || !fs.existsSync(path.join(byProperty, 'state-store', 'heart', 'heart-store.js'))) {
...
const MANIFEST = [
  ['runtime/index.js', 'main'], ['runtime/index.js', 'runRetentionSweep'],
  ['runtime/internal-api/dispatch.js', 'handleInspect'],
  ['runtime/internal-api/dispatch.js', 'handleInspectDaemon'],
  ['runtime/internal-api/dispatch.js', 'handleInspectTicker'],
  ['supervisor/spawn/spawn.js', 'orphanRescan'],
  ['runtime/ticker/ticker.js', 'advance'], ['runtime/ticker/ticker.js', 'enforce'],
  ['runtime/ticker/ticker.js', 'liveSessionTurns'], ['runtime/ticker/ticker.js', 'openTurnRows'],
  ['runtime/ticker/warnings-check.js', 'findBlockedBudgetExhaustedSubjects'],
];
...
{
  const sameFileOnly = callsOf('runWarningCheck', 'runtime/ticker/warnings-check.js');
  const withExports = callersOfSymbol('runtime/ticker/warnings-check.js', 'runWarningCheck');
  line('');
...
const CONSUMER_MANIFEST = {
  ...
  'runtime/index.js:(module)': 'plumbing',
  'runtime/internal-api/dispatch.js:dispatch': 'plumbing',
  'runtime/ticker/ticker.js:createTicker': 'plumbing',
  'runtime/ticker/ticker.js:launchAgent': 'asks',
  'runtime/ticker/ticker.js:findLiveExecutionForThread': 'asks',
  'runtime/ticker/warnings-check.js:runWarningCheck': 'asks',
  ...
  'runtime/ticker/ticker.js:dispatch': 'horizon',
  'runtime/ticker/ticker.js:isSlotLiveOrRearmed': 'horizon',
};
