...
const { createAuthzPolicy } = require('../../../runtime/internal-api/authz');
...
const liveCfg = yaml.load(fs.readFileSync(path.join(__dirname, '..', '..', '..', 'envelope', 'spawn-profiles.yaml'), 'utf8'));
