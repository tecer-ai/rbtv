...
//
// THE LEASE IS NOT COMPUTED HERE (PRIN-11). `runtime/lease/lease.js` is the one home of "is this
...
function describeGate() {
  return [
    ...
    'executing answer: runtime/lease/lease.js deriveLease() — the goal\'s tmux room existing NOW',
