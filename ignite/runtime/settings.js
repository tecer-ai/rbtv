...
//
//   * the DAEMON, at boot — `runtime/index.js` overlays this machine's block onto the merged config
...
// The daemon seeds `{}` (`runtime/index.js`); the installer seeds `{"machines": {}}`. Whichever ran
