...
// `envelope/spawn-profiles.yaml` and from `cage.js SCALAR_SLOTS` in the same change, so the alias
...
//
// The liveness half is now `runtime/lease/lease.js` and NOTHING is computed here (PRIN-11, design
