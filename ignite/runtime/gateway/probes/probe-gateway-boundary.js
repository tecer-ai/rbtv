...
const FORBIDDEN = [
  ...
  { what: 'server-core internals', re: /require\s*\(\s*['"][^'"]*(?:\/|\.\.\/)(?:server|ticker|internal-api|lease|seat-identity)\/[^'"]*['"]\s*\)/ },
...
try {
  ...
  const MUTATIONS = [
    { what: 'heart store module', code: "const s = require('../../state-store/heart/heart-store');\nmodule.exports = s;" },
    { what: 'spawn module', code: "const s = require('../../supervisor/spawn/spawn');\nmodule.exports = s;" },
    { what: 'server-core internals', code: "const t = require('../ticker/ticker');\nmodule.exports = t;" },
