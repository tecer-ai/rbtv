...
//
// That left `canKillSession` covered by exactly one probe (`ignite-cli/probes/probe-cli-kill.js`) which
...
// daemon to fake a proven seat would mean teaching `runtime/index.js` an injection seam that exists
