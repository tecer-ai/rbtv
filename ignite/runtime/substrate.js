...
const DEGRADED_BRANCHES = Object.freeze([
  Object.freeze({
    site: 'carrier',
    posix: 'systemd-run --user (or setsid), selected by supervisor/spawn/carrier.js selectCarrier()',
  ...
  Object.freeze({
    ...
    posix: 'bwrap bind-mount cage (supervisor/spawn/bwrap.js, supervisor/spawn/cage.js)',
  ...
  Object.freeze({
    site: 'seat-room',
    posix: 'a tmux room + one pane per seat (supervisor/spawn/tmux.js)',
