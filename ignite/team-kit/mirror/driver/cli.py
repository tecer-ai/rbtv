...
-----
    ...
    python -m driver.cli --target <workspace> codex-cli opencode

    # report drift without writing (exit 1 if anything is stale/missing)
    python -m driver.cli --target <workspace> codex-cli opencode --check
    ...
    python -m driver.cli --target <workspace> --uninstall codex-cli --remaining opencode
