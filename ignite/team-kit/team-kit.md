...
| `roles.md` | The role catalogue (leader, deputy, scientist, judge, verifier, worker, closer) + the codex/opencode harness note — read by a seat that HOLDS one of the special roles or runs a non-claude harness. Split out of `protocol.md` 2026-07-28. |
