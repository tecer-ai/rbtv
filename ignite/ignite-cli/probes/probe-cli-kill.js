...
const { setsidStatus } = require(path.join(IGNITE_SRC, 'supervisor', 'spawn', 'carrier'));
const { auditPathFor } = require(path.join(IGNITE_SRC, 'runtime', 'internal-api', 'keys-audit'));
