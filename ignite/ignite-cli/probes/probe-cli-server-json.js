...
const { selectMachineEntry, resolveGatewayAddr, resolveToken } = require(path.join(IGNITE_SRC, 'ignite-cli', 'lib', 'config'));
const { CliUsageError } = require(path.join(IGNITE_SRC, 'ignite-cli', 'lib', 'errors'));
