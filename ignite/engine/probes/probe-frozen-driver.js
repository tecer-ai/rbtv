...
//      facts shaped exactly as `engine/lane-watch.js` collects them, and the alarm that comes out
...
const { restartSuppression, ledgerPathFor } = require('../restart-window');
const { frozenFactsFor } = require('../lane-watch');
