...
function resolveConfig(overrides = {}) {
  ...
  // door (`supervisor/launch-profiles/catalog.js#specForSeatCast`), and a seat that declares no cast REFUSES
  ...
  // is the SAME one `observation/daemon-watchdog/tool/watchdog-alarm.js` reads, because there is
