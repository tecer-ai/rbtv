...
const { resolvePeerSeat, isLoopback, findSocketHolders } = require('../../../runtime/seat-identity/peer-identity');
...
capture('probe-peer-identity', async (lines) => {
  ...
  // The identity gate this path shares now asks `runtime/lease/lease.js` whether the goal is
