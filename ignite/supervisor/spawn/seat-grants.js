...
//
// Extracted VERBATIM from spawn.js so `envelope/cage-admission.js` — the pre-enqueue admission
...
// (`spawn.js#resolveCliWriteRootGrants`, W6) — and for `envelope/cage-admission.js`, which composes
