...
// THE ONE NON-ENTRY, AND IT IS LOAD-BEARING (adv C55). `ignite-cli/lib/config.js#readEnvFileToken` walks
// up from the seat's cwd for `.rbtv/config/sender-token.env` and reads IGNITE_SENDER_TOKEN out of
// it — VERIFIED 2026-08-13 at `ignite-cli/lib/config.js:178-207`; it is the ONLY file `resolveToken`
