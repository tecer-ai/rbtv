...
const KNOWN_TOP_KEYS = new Set([
  'bind', 'auth', 'spawn', 'launch-specs', 'jobs', 'default_workdir_root', 'cage', 'caps', 'sandbox_default', 'caps_default', 'toolsets',
]);

// ⚠ 7.42 — measured, not assumed: the COMMITTED `envelope/spawn-profiles.yaml` carries root keys
// that are NOT the profile surface's. `runtime/index.js` (DAEMON_ONLY_ROOT_KEYS) strips them and
...
//
// `resolveProfile` (below) calls it, and so does the daemon's own `supervisor/spawn/spawn.js#composeArgv`
