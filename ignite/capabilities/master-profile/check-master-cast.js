...
//
// The door being mirrored is `server/spawn/live-sessions.js#eligible()`: it resolves the SEAT'S
...
const { launchSpecForSeat } = require(path.join(IGNITE, 'server', 'spawn', 'spawn.js'));
