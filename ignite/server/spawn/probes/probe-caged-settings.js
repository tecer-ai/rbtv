...
//
//   1. ALL FOUR claude specs rewrite, loaded from the real `config/spawn-profiles.yaml`
...
check('no per-spec special case anywhere in server/spawn/ (probes excluded, see grepFiles)',
