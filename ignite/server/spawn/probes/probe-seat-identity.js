...
const { parseSeatPath, checkGoalExecuting, checkMaterializedSeat } = require('../../seat-identity/seat-folder');
...
//
// L2 is no longer a `runs.csv` read; it is `server/lease/lease.js` — the goal's tmux room existing
