...
const MANIFEST = [
  ...
  { site: 'server/internal-api/dispatch.js:handleInspectDaemon',
    asks: 'SESSION', reads: 'TURN', row: 'G-226',
    note: 'live_agent_sessions count' },

  { site: 'server/internal-api/dispatch.js:handleInspectTicker',
  ...
  { site: 'server/internal-api/dispatch.js:handleInspect',
  ...
  { site: 'server/ticker/ticker.js:advance',
    asks: 'TURN', reads: 'TURN',
  ...
  { site: 'server/ticker/ticker.js:enforce',
    asks: 'SESSION', reads: 'SESSION',
  ...
  { site: 'server/ticker/warnings-check.js:findBlockedBudgetExhaustedSubjects',
    asks: 'TURN', reads: 'TURN',
