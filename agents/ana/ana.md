...
<submenu id="product">
  ...
  <item cmd="PRD or fuzzy match on prd" exec="{bmad_bmm}/workflows/2-plan-workflows/create-prd/workflow-create-prd.md">[PRD] PRD — Create/Validate/Edit Product Requirements Document</item>
