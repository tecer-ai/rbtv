...
3. **Load** model/platform knowledge from DomCobb's prompting knowledge index at `{project-root}/_bmad/rbtv/workflows/prompting-assistance/data/knowledge-index.csv`
