...
<menu>
  <item cmd="PD or fuzzy match on pitch, deck, design, slides, generate, HTML" workflow="{project-root}/_bmad/rbtv/workflows/pitch-creation/steps-c/step-07-generate.md">[PD] Pitch Deck Design: Generate the visual deck from a completed structure</item>
  <item cmd="PI or fuzzy match on images, image, prompts, visual, AI image" workflow="{project-root}/_bmad/rbtv/workflows/pitch-creation/steps-c/step-08-images.md">[PI] Pitch Images: Craft AI image prompts for pitch deck visuals</item>
  <item cmd="BV or fuzzy match on brand, visual, identity, brandbook, colors, typography, logo" workflow="{project-root}/_bmad/rbtv/workflows/bi-m3-brandbook/steps-c/step-03-visual.md">[BV] Brand Visual Identity: Design visual guidelines for a brand book</item>
