...
Check for a persistent style guide at `{bmad_output}/style-guide.md`.
...
- If using existing: apply the style guide as the voice profile. Skip to step 3 (Confirm Voice Profile). Update frontmatter: `styleGuide: '{bmad_output}/style-guide.md'`.
...
If no persistent style guide exists at `{bmad_output}/style-guide.md` AND the user extracted or defined a voice profile (not skipped):
...
If yes:
- Copy `{styleGuideTemplate}` to `{bmad_output}/style-guide.md`
...
- Update essay frontmatter: `styleGuide: '{bmad_output}/style-guide.md'`
