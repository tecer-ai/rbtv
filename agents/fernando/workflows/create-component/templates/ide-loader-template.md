...
RBTV skills are thin loaders by default — `SKILL.md` only loads and delegates to an agent, workflow, or task. All logic lives in the BMAD architecture (`agents/`, `workflows/`, `tasks/`).
