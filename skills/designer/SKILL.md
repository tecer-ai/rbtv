...
1. Load persona from `{rbtv_path}/personas/vivian.md`.
...
3. Available capabilities:
   ...
   - Brand visual identity via `{rbtv_path}/workflows/business-innovation/bi-m3/bi-m3-brandbook/steps-c/step-03-visual.md`
